            ...
            >
                ...
                >
                    <div>
                        ...
                        <p className={`${styles.grey} ${styles.sans}`}>Or check out my <a href="https://drive.google.com/file/d/1tnVP5Q4tE2FTTZm91ObUuJjvOHq3CB09/view?usp=sharing" target="_blank" style={{ color: "var(--color-blue-200)" }}>resume</a>!</p>
                    </div>
                </div>
            </div>
        );
