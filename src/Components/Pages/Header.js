            ...
            <Navbar activekey="/home" collapseOnSelect expand="lg" fixed="top" variant="dark">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="m-auto justify-content-center">
                        ...
                        <Nav.Link onClick={() => {scroller.scrollTo('Resume', scrollOpts)}} style={{mixBlendMode: "difference"}}>Work Experience</Nav.Link>
                        <Nav.Link onClick={() => {scroller.scrollTo('Projects', scrollOpts)}} style={{mixBlendMode: "difference"}}>Projects</Nav.Link>
                        <Nav.Link onClick={() => {scroller.scrollTo('Contact', scrollOpts)}} style={{mixBlendMode: "difference"}}>Contact</Nav.Link>
                    </Nav>
                </Navbar.Collapse>
            </Navbar>
        </div>
